...
function nextnews_css() {
  ...
  if(!empty($options['fixed_menu_logo_w'])) { $custom_styles .='.fix-menu.fixed-logo-active .mt-menu-bar-brand-hidde.mt-menu-bar-brand, .fix-menu.fixed-logo-active .mt-menu-bar-brand-hidde.mt-menu-bar-brand > a.logo-fixed > img { width: '.$options['fixed_menu_logo_w'].' !important; }'; }

...
add_action( 'tgmpa_register', 'nextnews_register_required_plugins' );
/**
 ...
 */
function nextnews_register_required_plugins() {
    ...
    $plugins = array(
        array(
            'name'			=> esc_html__( "Envato Market","nextnews" ), // The plugin name
        ...
        array(
        			'name'     				=> esc_html__( "Page Builder by SiteOrigin","nextnews" ), // The plugin name
        			'slug'     				=> 'siteorigin-panels', // The plugin slug (typically the folder name)
        			'required' 				=> true, // If false, the plugin is only 'recommended' instead of required
              'force_activation'		=> false,
        ),
        array(
        			'name'     				=> esc_html__( "One Click Demo Import","nextnews" ), // The plugin name
        			'slug'     				=> 'one-click-demo-import', // The plugin slug (typically the folder name)
        			'required' 				=> true, // If false, the plugin is only 'recommended' instead of required
              'force_activation'		=> false,
        ),
        array(
            'name'			=> esc_html__( "Magazine Plug","nextnews" ), // The plugin name
     ...
     */
    $config = array(
      'id'           => 'nextnews',                // Unique ID for hashing notices for multiple instances of TGMPA.
